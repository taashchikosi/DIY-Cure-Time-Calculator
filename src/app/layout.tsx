...
export const metadata: Metadata = {
  title: {
    default: 'DIY Cure Time Calculator',
    template: '%s | DIY Cure Time Calculator',
  },
  description:
    'Calculate accurate cure times for wood glue, epoxy, silicone, construction adhesive, and concrete — adjusted for your temperature and humidity.',
